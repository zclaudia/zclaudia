...
import { drawerStageBelow } from './features/sidebar/drawerStage';
import { useMobileDrawer } from './app/useMobileDrawer';
...
function AppContent() {
  ...
  const {
    ...
    isMobile,
    gestureActive: isAppTopLevelView || isShellTopLevelView,
    isAgentExpanded,
    isFeedOpen,
    isFileViewerFullscreen: fileViewerFullscreen,
  });
