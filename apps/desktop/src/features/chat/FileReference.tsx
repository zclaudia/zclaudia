...
export function TextWithFileRefs({
  ...
  const refClassName =
    variant === 'user'
      ? 'font-mono inline rounded-[var(--radius-inline-token)] px-1 py-0.5 border border-primary-foreground/40 bg-primary-foreground/20 text-foreground hover:bg-primary-foreground/30 hover:underline cursor-pointer'
