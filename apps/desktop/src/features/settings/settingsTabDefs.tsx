...
export type SettingsTab = 'general' | 'agent' | 'permissions' | 'providers' | 'notifications' | 'gateway' | 'plugins' | 'mcp-servers' | 'workspace' | 'debug' | `plugin:${string}`;
...
export function getServerTabs({ isActiveLocalBackend, pluginSettingsTabs }: ServerTabsOptions): SettingsTabDef[] {
  return [
    {
      id: 'agent',
      label: 'Claudia',
