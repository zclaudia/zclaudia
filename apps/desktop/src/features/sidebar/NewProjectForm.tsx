...
export function NewProjectForm({
  ...
  const createBtnClass = isMobile
    ? 'flex-1 px-3 py-2.5 bg-muted/60 text-foreground hover:bg-muted active:bg-muted/60 rounded-lg text-sm disabled:opacity-50'
    : 'flex-1 px-2 py-1 bg-muted/60 text-foreground hover:bg-muted rounded-lg text-xs disabled:opacity-50';
