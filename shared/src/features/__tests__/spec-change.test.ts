...
describe('OpenSpec G1 shared type sanity', () => {
  ...
  it('shapes compile', () => {
    const sc: SpecChange = {
      ...
      title: 'Add 2FA',
      status: 'drafting',
      proposalPath: 'openspec/changes/add-2fa/proposal.md',
      designPath: 'openspec/changes/add-2fa/design.md',
      tasksPath: 'openspec/changes/add-2fa/tasks.md',
      deltaSpecPaths: [],
