...
export const BUILTIN_TOOL_METADATA: Readonly<Record<ToolName, ToolMetadata>> = {
  ...
  MultiEdit: {
    ref: { source: 'builtin', name: 'MultiEdit' },
    label: 'MultiEdit',
    description: 'Apply multiple targeted edits to one existing workspace file atomically.',
    setIds: ['core-coding'],
    declaredReadOnly: false,
    mutatesWorkspace: true,
    requiresNetwork: false,
  ...
  ReadSymbol: {
    ref: { source: 'builtin', name: 'ReadSymbol' },
    label: 'ReadSymbol',
    description: 'Read one named code symbol from a Python, TypeScript, or JavaScript file.',
    setIds: ['core-coding', 'code-intelligence'],
    declaredReadOnly: true,
    mutatesWorkspace: false,
    requiresNetwork: false,
    requiresUserInteraction: false,
  ...
  EditSymbol: {
    ref: { source: 'builtin', name: 'EditSymbol' },
    label: 'EditSymbol',
    description: 'Replace one named code symbol in a Python, TypeScript, or JavaScript file.',
    setIds: ['core-coding', 'code-intelligence'],
    declaredReadOnly: false,
    mutatesWorkspace: true,
    requiresNetwork: false,
...
export const BUILTIN_TOOL_SETS = {
  ...
  'code-intelligence': {
    ...
    tools: ['LSPTool', 'AstGrep', 'AstEdit', 'ReadSymbol', 'EditSymbol'],
  },
  'all-builtin': {
    id: 'all-builtin',
