...
import { decodeTextBuffer, applyLineEndingStyle, lineEndingFor, readTextFileWithMetadata, writeTextFileAtomic } from './text-io.js';
...
import { findAutoGeneratedMarker, buildAutoGeneratedMessage } from './auto-generated-guard.js';
...
function createExitWorktreeTool(cwd: string, options?: ToolBridgeOptions): AgentTool<any> {
  return {
    name: 'ExitWorktree',
    label: 'ExitWorktree',
...
function createAstGrepTool(cwd: string): AgentTool<any> {
  return {
    name: 'AstGrep',
    label: 'AstGrep',
...
function createAstEditTool(cwd: string, options?: ToolBridgeOptions): AgentTool<any> {
  return {
    name: 'AstEdit',
    label: 'AstEdit',
