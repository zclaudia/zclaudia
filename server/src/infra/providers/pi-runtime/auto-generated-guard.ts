...
const COMMENT_STYLES_BY_EXTENSION = new Map<string, readonly CommentStyle[]>([
  ['.c', ['slash']], ['.cc', ['slash']], ['.cpp', ['slash']], ['.cs', ['slash']],
  ['.dart', ['slash']], ['.go', ['slash']], ['.h', ['slash']], ['.hpp', ['slash']],
  ['.java', ['slash']], ['.js', ['slash']], ['.jsx', ['slash']], ['.kt', ['slash']],
  ['.kts', ['slash']], ['.mjs', ['slash']], ['.cjs', ['slash']], ['.php', ['slash']],
  ['.rs', ['slash']], ['.scala', ['slash']], ['.swift', ['slash']], ['.ts', ['slash']],
  ['.tsx', ['slash']],
  ['.py', ['hash']], ['.rb', ['hash']], ['.sh', ['hash']], ['.bash', ['hash']],
  ['.zsh', ['hash']], ['.yml', ['hash']], ['.yaml', ['hash']], ['.toml', ['hash']],
  ['.ini', ['hash']], ['.cfg', ['hash']], ['.conf', ['hash']], ['.env', ['hash']],
  ['.pl', ['hash']], ['.r', ['hash']],
  ['.sql', ['sql']],
 ...
 */
export function findAutoGeneratedMarker(filePath: string, content?: string | null): string | undefined {
...
export function buildAutoGeneratedMessage(displayPath: string, marker: string): string {
  return `Cannot modify auto-generated file: ${displayPath} (detected marker: "${marker}"). `
