  ...
  phases: [
    {
      ...
      dependsOn: [],
      inputs: [],
      outputs: [{ kind: 'file', path: 'design/a.md', description: 'spec' }],
      acceptanceGates: [
        { id: 'g1', description: 'doc exists', command: 'test -f design/a.md', expect: {} },
      ],
    },
    {
      id: 'p2',
      ...
      dependsOn: ['p1'],
      inputs: [{ kind: 'file', source: 'design/a.md' }],
      outputs: [{ kind: 'commit', description: 'impl' }],
      acceptanceGates: [
        { id: 'g2', description: 'compile', command: 'mvn compile', expect: { exitCode: 0 } },
      ],
    },
  ],
  smokePath: ['p1', 'p2'],
