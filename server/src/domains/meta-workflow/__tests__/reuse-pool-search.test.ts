...
import { migration as m001 } from '../../../infra/storage/migrations/001_initial_schema.js';
...
const phaseDef: PhaseDef = {
  id: 'p1',
  name: 'Impl UserService',
  description: 'Implement UserServiceImpl with JPA',
...
describe('ReusePoolSearchService', () => {
  ...
  it('scores by token-overlap on description', () => {
    ...
    poolRepo.create({
      ...
      entityId: 'b',
      phaseType: 'code-implement',
      description: 'Implement JPA user repository',
      tags: [],
      sourceType: 'auto',
      createdAt: 20,
    });
  ...
  it('promoted items rank above auto-generated of equal score', () => {
    poolRepo.create({
      ...
      entityId: 'auto',
      phaseType: 'code-implement',
      description: 'identical text here',
      tags: [],
      sourceType: 'auto',
      createdAt: 10,
    });
  ...
  it('respects kind filter from executeEntity', () => {
    ...
    const invPhase: PhaseDef = {
      ...phaseDef,
      phaseType: 'investigation',
      executeEntity: 'subagent',
    };
